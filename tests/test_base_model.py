...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        base_mod = BaseModel(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(base_mod.id, "345")
        self.assertEqual(base_mod.created_at, dt)
        self.assertEqual(base_mod.updated_at, dt)
    ...
    def test_instantiation_with_args_and_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        base_mod = BaseModel("12", id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(base_mod.id, "345")
        self.assertEqual(base_mod.created_at, dt)
        self.assertEqual(base_mod.updated_at, dt)
